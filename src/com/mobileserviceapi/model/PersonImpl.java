...
public class PersonImpl implements Person {
	...
	@NotNull
	@Size(min=2, max=30, message = "Username should be between 2-30 characters long")
	public String username;
	
	@NotNull
	@Size(min=2, max=30, message = "Password should be between 2-30 characters long")
	 ...
	 * @param lastname
	 */
	public PersonImpl(int id, String username, int enabled, String email,
	 ...
	 * @param lastname
	 */
	public PersonImpl(int id, String username, String password, int enabled,

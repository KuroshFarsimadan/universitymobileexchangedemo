  ...
  <div class="panel-heading">
  	<sec:authorize access="hasRole('ROLE_USER')">
	    <ul class="nav nav-tabs">
		  ...
		  <li role="presentation" class="active"><a href="updateMobiles">Update mobiles</a></li>
		</ul>
   	</sec:authorize> 
  ...
  <div class="panel-body">
	  	...
	  	<table>
	        ...
	        <tbody>
		 		...
		 		<tr>
			        <td width="150"><c:out value="${mobile.personId}"/></td>
			        <td width="150"><c:out value="${mobile.rowId}"/></td>
			        <td width="600"><c:out value="${mobile.mobileManufacturer}"/></td>
			        <td width="400"><c:out value="${mobile.mobileModel}"/></td>
			        <td width="600"><c:out value="${mobile.mobileSpecs}"/></td>
			        <td width="600"><c:out value="${mobile.mobileFreedescription}"/></td>
			        <td width="600"><c:out value="${mobile.price}"/></td>
		        </tr>
